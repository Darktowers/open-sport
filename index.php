    ...
    <div class="gratis">
        ...
        <div class="content">
            ...
            <p><b>Opensport</b> es la única plataforma en España que te permitirá ver <br>
                ...
                en directo que siempre has buscado y <br>nunca has encontrado.
            </p>
...
<div class="precont">
    <div class="competencias">
        ...
        <p>Además podrás ver en vivo los mejores combates de
            <B>kickboxing, MMA, deportes extremos como surf, skate, bmx y esquí, competiciones de eSports, buceo</B> y mucho más</p>
        <a href="" class="btn btn-purple">CONOCE TODA NUESTRA PROGRAMACIÓN</a>
    </div>
</div>
<div class="precont noti " style="background:black !important;">
<div class="noticias">
    <div class="img">
...
<section class="content-tab cont-2">
    <img class="back" src="img/rectangles-green.png" alt="">
    <div class="disfruta">
        <div class="content">
            <h2>Disfruta del contenido en todos los dispositivos</h2>
            <p>Empieza a ver el deporte que quieras <b>en menos de 5 minutos.</b></p>
            <p><b>¿Qué necesito para ver <b>Opensport</b> en mis dispositivos?</b>
            </p>
            <p>Consulta la sección <b class="t_purple">dispositivos</b> para ver <b>Opensport</b> desde cada dispositivo</p>
            <div class="devices">
                <div class="device">
                    <img src="img/pc.png" style="width: 240px;" alt="">
<div class="labelcontent">
    <div class="label">
        <p>Accede online a través de www.<b>opensport</b>.es desde los navegadores Chrome, Firefox, Safari, Internet Explorer,
            Edge y Opera en PC o Mac.</p>
    </div>
</div>
</div>
<div class="device">
    <img src="img/tablet.png" style="width: 240px;" alt="">
<div class="labelcontent">
    <div class="label">
        <p>•Teléfonos y tabletas Android. Descárgate la app <b>Opensport</b> en Google Play. Es válida desde la versión del
            sistema operativo Android 4.3 <br> •Teléfonos y tabletas Apple. Descárgate la app <b>Opensport</b> en Apple Store.
            Disponible para todos los dispositivos con sistema operativo iOS 8.0 en adelante.
        </p>
    </div>
</div>
</div>
<div class="device">
    <img src="img/phone.png" style="width: 240px;;" alt="">
<div class="labelcontent">
    <div class="label">
        <p>•Teléfonos y tabletas Android. Descárgate la app <b>Opensport</b> en Google Play. Es válida desde la versión del
            sistema operativo Android 4.3 <br> •Teléfonos y tabletas Apple. Descárgate la app <b>Opensport</b> en Apple Store.
...
<div class="devices">
    <div class="device">
        <img src="img/smartTV.png" style="width: 240px;" alt="">
<div class="labelcontent">
    <div class="label">
        <p>Disfruta de <b>Opensport</b> en tu televisor de diferentes formas: Conecta con un cable HDMI al televisor la salida
            HDMI de tu PC o Mac, dispositivo Android o iOS o bien mediante un Chromecast o el Airplay en Apple TV. </p>
    </div>
</div>
</div>
</div>
...
<div class="labelcontent">
    <div class="label">
        <p>Descárgate la app <b>Opensport</b> en Google Play para smart TVs y decodificadores certificados Android TV como:
            Xiaomi Mi Box, Sony BRAVIA y Sharp AQUOS.</p>
    </div>
</div>
</div>
...
<div class="test-speed">
    ...
    <div class="content">
        ...
        <a href="" class="btn btn-black">TEST DE VELOCIDAD</a>
    </div>
</div>
</section>
<section class="content-tab cont-3">
    ...
    <div class="planes">
        <div class="content">
            ...
            <p>Disfruta de todo el deporte en streaming dónde y cuándo quieras... en tu smartTV, <br> consola, PC, Mac, móvil,
                tableta y más dispositivos. Empieza ahora con un mes gratis
            </p>
            <div class="planes-Container">
                ...
                <div class="segment">
                    ...
                    <div class="plan-item mes active questionco">
                        <p>1 mes <i class="fa fa-question-circle-o"></i></p>
                        <div class="question">
                            <p>30 días en adelante</p>
                        </div>
                    </div>
                    <div class="plan-item jornada questionco">
                        <p>1 semana <i class="fa fa-question-circle-o"></i></p>
                        <div class="question">
                            <p>semana actual de lunes a domingo ambos incluidos</p>
                        </div>
                    </div>
                </div>
                <div class="segment">
            ...
            <div class="jornada-movil">
                <div class="segment">
                    <div class="plan-item empty"></div>
                    <div class="plan-item mes active">
                        <div class=" tab-mes tab-active">Mes</div>
                    </div>
                </div>
                <div class="segment">
                    <div class="plan-item">
            ...
            <div class="mes-movil">
                <div class="segment">
                    <div class="plan-item empty"></div>
                    <div class="plan-item jornada active">
                        <div class=" tab-jornada tab-active">Semana</div>
                    </div>
                </div>
                <div class="segment">
                    <div class="plan-item">
    ...
    <div class="precont">
        <div class="competencias">
            ...
            <p>Además podrás ver en vivo los mejores combates de kickboxing, MMA, deportes extremos como surf, skate, bmx y
                esquí, competiciones de eSports, buceo y mucho más</p>
            <a href="" class="btn btn-purple">CONOCE TODA NUESTRA PROGRAMACIÓN</a>
        </div>
    </div>
</section>
