...
<a href="profile.php"><p><i class="fa fa-angle-left"></i>VOLVER</p></a>
    ...
    <div class="facturacion">
        <div class="colx principal"><p>CAMBIAR CONTRASEÑA</p></div>
        <div class="colx">
            <div class="formul contra">
                <form action="">
                    ...
                    <div class="required">
                        <img src="img/icon-required.svg" alt="">
                        <p>Es obligatorio volver a iniciar sesión en todos los <br> disponibles con la nueva contraseña </p>
                    </div>
                    <div class="buttons">
